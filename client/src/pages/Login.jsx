				...
				<div className="w-full max-w-md">
					...
					<div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8">
						...
						<div className="text-center mb-8">
							<h1 className="text-3xl font-bold text-white mb-2">Welcome to JCS POS</h1>
						</div>
						
						<form onSubmit={onSubmit} className="space-y-6">
							<div>
								<input 
									className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/40 transition-all" 
							...
							<button 
								className="w-full bg-blue-900 hover:bg-blue-800 text-white font-semibold rounded-xl py-3 transition-all transform hover:scale-[1.02] disabled:opacity-60 disabled:transform-none" 
