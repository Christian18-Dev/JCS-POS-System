...
export default function NewOrder() {
	...
	const createOrder = async () => {
		...
		if (action.meta.requestStatus === 'fulfilled') {
			...
			const confirmAction = await dispatch(confirmOrderThunk(orderId));
			...
			{showCartModal && (
				...
				>
					<div className="bg-white rounded-xl shadow-xl w-full max-w-2xl sm:max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden">
						...
						<button 
										className="flex-1 bg-green-600 hover:bg-green-700 text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg shadow-sm hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200" 
							onClick={createOrder} 
						>
							...
							<div className="flex items-center justify-between">
								<div className="flex items-center">
									...
									<div>
										...
										<p className="text-sm text-gray-600">Invoice #{lastOrder.invoiceNumber}</p>
									</div>
								</div>
								<button 
								...
								<div className="bg-gray-50 rounded-lg p-4">
									...
									<div className="space-y-2">
										<div className="flex justify-between">
											...
											<span className="font-medium">#{lastOrder.invoiceNumber}</span>
										</div>
										<div className="flex justify-between">
										...
										<div className="flex justify-between">
											...
											<span className="font-medium text-green-600 capitalize">{lastOrder.status}</span>
										</div>
									</div>
								</div>
