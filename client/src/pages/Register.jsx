				...
				<div className="w-full max-w-md">
					...
					<div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-6 sm:p-8">
						...
						<form onSubmit={onSubmit} className="space-y-4 sm:space-y-6">
							<div>
								<input 
									className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/40 transition-all text-base" 
							...
							<button 
								className="w-full bg-blue-900 hover:bg-blue-800 text-white font-semibold rounded-xl py-3 transition-all transform hover:scale-[1.02] disabled:opacity-60 disabled:transform-none text-base touch-manipulation" 
					...
					<div className="text-center mt-6 sm:mt-8">
						<p className="text-blue-200 text-sm">
							...
							<Link to="/login" className="text-white hover:text-blue-100 font-medium transition-colors">Sign in</Link>
						</p>
					</div>
				</div>
			</div>
